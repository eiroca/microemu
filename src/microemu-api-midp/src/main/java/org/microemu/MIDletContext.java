...
/**
 * 
 * Represents context for running MIDlet. Enables access to MIDlet, MIDletAccess by threadLocal
 * using MIDletBridge. Created before MIDlet.
 * 
...
public class MIDletContext {
  ...
  public MIDlet getMIDlet() {
    if (midletAccess == null) { return null; }

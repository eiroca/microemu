...
public abstract class Item {
  ...
  public int getMinimumHeight() {
    if (labelComponent != null) return labelComponent.getHeight();
    else return 0;
  }
  ...
  public void removeCommand(Command cmd) {
    ...
    if (defaultCommand == cmd) defaultCommand = null;
    repaintOwner();
  }
  ...
  public void setDefaultCommand(Command cmd) {
    ...
    if (cmd != null) {
      ...
      if (commands.contains(cmd)) addCommand(cmd);
      else repaintOwner();
    }
    else {
      repaintOwner();
  ...
  public void setLayout(int layout) {
    ...
    if ((((layout & LAYOUT_SHRINK) != 0) && ((layout & LAYOUT_EXPAND) != 0)) || (((layout & LAYOUT_VSHRINK) != 0) && (layout & LAYOUT_VEXPAND) != 0)) throw new IllegalArgumentException("Bad combination of layout policies");
    this.layout = layout;
    repaint();
  }

...
public class PasswordAuthentication {
   ...
   * 
   * @exception NullPointerException if <code>password</code> is <code>null</code>
   */
  ...
  /**
   * Retrieves the user name that was specified in the constructor. The user name may be
   * <code>null</code>.
   * 

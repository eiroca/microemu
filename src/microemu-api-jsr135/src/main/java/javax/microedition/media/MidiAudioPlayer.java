...
class MidiAudioPlayer implements Player, MetaEventListener {
  ...
  public long getMediaTime() {
    if (sequencer != null) return sequencer.getMicrosecondPosition();
    return 0;
  }
  ...
  public long setMediaTime(long now) throws MediaException {
    if (sequencer != null) sequencer.setMicrosecondPosition(now);
    return now;
  }
  ...
  public Control getControl(String controlType) {
    if ("VolumeControl".equals(controlType)) { return new J2SEVolumeControl(); }
    return null;
  }

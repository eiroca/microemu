...
public class TiledLayer extends Layer {
  ...
  public TiledLayer(int columns, int rows, Image image, int tileWidth, int tileHeight) {
    ...
    if (((image.getWidth() % tileWidth) != 0) || ((image.getHeight() % tileHeight) != 0)) { throw new IllegalArgumentException(); }
  ...
  public void setStaticTileSet(Image image, int tileWidth, int tileHeight) {
    // if img is null img.getWidth() will throw NullPointerException
    if (tileWidth < 1 || tileHeight < 1 || ((image.getWidth() % tileWidth) != 0) || ((image.getHeight() % tileHeight) != 0)) { throw new IllegalArgumentException(); }

...
/**
 * Dynamic proxy class for GCF Connections returend to MIDlet Used to debug excetions thrown to
 * MIDlet Makes PrivilegedCalls when rinning in Webstart
 *
 * @author vlads
 */
public class ConnectionInvocationHandler implements InvocationHandler {
  ...
  public ConnectionInvocationHandler(final Connection con, final boolean needPrivilegedCalls) {
    originalConnection = con;

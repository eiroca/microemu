 ...
 * @author vlads
 *
 *         This code is added to MIDlet application to solve problems with security policy while
 *         running in Applet and Webstart. Also solves resource resource loading paterns commonly
 *         used in MIDlet and not aceptable in Java SE application The calls to this code is
 *         injected by ClassLoader or "Save for Web...".
 *
 *         This class is used instead injected one when application is running in Applet with
 *         MicroEmulator.
 *
...
public final class Injected implements Serializable {
  ...
  /**
   * This code Ingected By MicroEmulator to enable access to System properties while running in
   * Applet
   *
   ...
   *         found
   */
  public static InputStream getResourceAsStream(final Class origClass, final String name) {
   ...
   */
  public static Throwable handleCatchThrowable(final Throwable t) {
    Logger.error("MIDlet caught", t);
    return t;
  }

...
public class RecordStoreChangePanel extends SwingDialogPanel {
  ...
  private final JComboBox selectStoreCombo = new JComboBox(new String[] {
      "File record store", "Memory record store"
  });

  public RecordStoreChangePanel(final Common common) {
    this.common = common;

...
public class SwingDialogWindow {
   ...
   */
  public static boolean show(final Frame parent, final String title, final SwingDialogPanel panel, final boolean hasCancel) {
    ...
    final ActionListener closeListener = event -> {

...
public class Message {
  ...
  public static void error(final String title, final String text) {
    ...
    Message.callListeners(Message.ERROR, title, text, null);
  }
  ...
  public static void error(final String text) {
    ...
    Message.callListeners(Message.ERROR, "Error", text, null);
  }
   ...
   * @param text Message
   */
  public static void error(final String title, final String text, final Throwable throwable) {
    Logger.error("Message: " + title + ": " + text, throwable);
    Message.callListeners(Message.ERROR, title, text, throwable);
  }

  public static void error(final String text, final Throwable throwable) {
    Logger.error("Message: Error : " + text, throwable);
    Message.callListeners(Message.ERROR, "Error", text, throwable);
  }
  ...
  public static void info(final String text) {
    ...
    Message.callListeners(Message.INFO, "Info", text, null);
  }
  ...
  public static void warn(final String text) {
    ...
    Message.callListeners(Message.INFO, "Warning", text, null);
  }
  ...
  private static void callListeners(final int level, final String title, final String text, final Throwable throwable) {
    for (final Iterator iter = Message.listeners.iterator(); iter.hasNext();) {
      final MessageListener a = (MessageListener)iter.next();
      a.showMessage(level, title, text, throwable);
    }
  }

  public static void addListener(final MessageListener newListener) {

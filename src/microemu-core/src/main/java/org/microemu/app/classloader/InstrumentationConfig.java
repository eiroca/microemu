...
public class InstrumentationConfig {
  ...
  public boolean isEnhanceCatchBlock() {
    return enhanceCatchBlock;
  }

  public void setEnhanceCatchBlock(final boolean enhanceCatchBlock) {
    this.enhanceCatchBlock = enhanceCatchBlock;
  }

  public boolean isEnhanceThreadCreation() {
    return enhanceThreadCreation;
  }

  public void setEnhanceThreadCreation(final boolean enhanceThreadCreation) {

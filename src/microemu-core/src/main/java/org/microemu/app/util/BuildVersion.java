...
public class BuildVersion {
  ...
  public static String getVersion() {
    final InputStream buildVersionInputStream = BuildVersion.class
    ...
    if (buildVersionInputStream != null) {
      ...
      try {
        ...
        if (version != null) {
          final String buildNumber = projectProperties.getProperty("build.buildNum");
          if (buildNumber != null) {
            version += "." + buildNumber;
          }
          return version;
    ...
    final InputStream mavenDataInputStream = BuildVersion.class
    ...
    if (mavenDataInputStream != null) {
      ...
      try {
        ...
        final String version = projectProperties.getProperty("version");

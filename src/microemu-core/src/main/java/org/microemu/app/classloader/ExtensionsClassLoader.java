...
public class ExtensionsClassLoader extends URLClassLoader {
  ...
  public ExtensionsClassLoader(final URL[] urls, final ClassLoader parent) {
    super(urls, parent);
   ...
   * this method will NOT invoke the parent class loader.
   * </p>
   *
  ...
  public URL getResource(final String name) {
    try {
      final URL url = (URL)AccessController.doPrivileged((PrivilegedExceptionAction<Object>)() -> findResource(name), acc);

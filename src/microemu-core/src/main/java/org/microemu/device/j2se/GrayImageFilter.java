...
public class GrayImageFilter extends RGBImageFilter {
  ...
  public GrayImageFilter(final double Yr, final double Yg, final double Yb) {
    this.Yr = Yr;
    this.Yg = Yg;
    this.Yb = Yb;
    canFilterIndexColorModel = true;
    final Color backgroundColor = ((J2SEDeviceDisplay)DeviceFactory.getDevice().getDeviceDisplay()).getBackgroundColor();
    final Color foregroundColor = ((J2SEDeviceDisplay)DeviceFactory.getDevice().getDeviceDisplay()).getForegroundColor();

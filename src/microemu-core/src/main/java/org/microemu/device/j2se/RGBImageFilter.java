...
public class RGBImageFilter extends java.awt.image.RGBImageFilter {
  ...
  public RGBImageFilter() {
    ...
    backgroundColor = ((J2SEDeviceDisplay)DeviceFactory.getDevice().getDeviceDisplay()).getBackgroundColor();
    foregroundColor = ((J2SEDeviceDisplay)DeviceFactory.getDevice().getDeviceDisplay()).getForegroundColor();

...
public class J2SEButtonDefaultKeyCodes {
  ...
  public static int[] getKeyCodes(final ButtonName name) {
    final KeyInformation info = (KeyInformation)J2SEButtonDefaultKeyCodes.codes.get(name);
    if (info == null) { return new int[0]; }
    return info.keyCodes;
  }

  public static String getCharCodes(final ButtonName name) {
    final KeyInformation info = (KeyInformation)J2SEButtonDefaultKeyCodes.codes.get(name);
    if (info == null) { return ""; }
  ...
  private static KeyInformation code(final ButtonName name, final int code) {
    final KeyInformation info = new KeyInformation();
    info.keyCodes = new int[] {
        code
    };
  ...
  private static KeyInformation code(final ButtonName name, final int code1, final int code2) {
    final KeyInformation info = new KeyInformation();
    info.keyCodes = new int[] {
        code1, code2
    };
  ...
  public static ButtonName getBackwardCompatibleName(final int keyboardKey) {

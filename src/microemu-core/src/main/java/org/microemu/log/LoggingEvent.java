...
public class LoggingEvent {
  ...
  public LoggingEvent(final int level, final String message, final StackTraceElement location, final Throwable throwable) {
    this();
    this.level = level;
  ...
  public LoggingEvent(final int level, final String message, final StackTraceElement location, final Throwable throwable, final Object data) {

 ...
 * limitations.
 *
 * Contributor(s): daniel(at)angrymachine.com.ar
 */
...
/**
 * The Softkey Codes are not generated by normal devices. In this class they are emulated with
 * commands. SOFTKEY1 is mapped to Command.OK and SOFTKEY2 to Command.BACK. You should edit your
 * device config file, so that OK is on the left and Back on the right.
 */

...
public class ImplFactory {
  ...
  /**
   * Allow default initialization. In Secure environment instance() should be called initialy from
   * secure contex.
   */
  ...
  public static void registerGCF(String scheme, Object implementation) {
    if (!(ConnectorDelegate.class.isAssignableFrom(implementation.getClass()))) { throw new IllegalArgumentException(); }
    if (scheme == null) {
      scheme = DEFAULT;
    }
